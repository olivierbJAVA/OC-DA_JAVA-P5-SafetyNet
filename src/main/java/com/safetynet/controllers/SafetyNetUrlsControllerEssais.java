...
@RestController
public class SafetyNetUrlsControllerEssais {

	private static final Logger logger = LoggerFactory.getLogger(SafetyNetUrlsControllerEssais.class);
	...
	//http://localhost:8080/phoneAlert?firestation=<firestation_number>
		...
		public void getPhoneAlert(@RequestParam int firestation) {
			...
			*/
			//return new ResponseEntity<>("bac", HttpStatus.FOUND);
